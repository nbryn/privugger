...
class TestProbabilityGenerators(unittest.TestCase):
    ...
    def test_sampling_samples_correct_order(self):
        ...
        prog = pv.Program("output", dataset=ds,
                          output_type=pv.Float, function=program_addition)
        # Program
    ...
    def test_multi_samples_correct_order(self):
        ...
        prog = pv.Program("output", dataset=ds,
                          output_type=pv.Float, function=program_multiplication)
        # Call infer
        trace = pv.infer(prog, draws=1000, cores=1)
        os.remove("typed.py")
    ...
    def test_uniform_cutoff(self):
        ...
        prog = pv.Program("output", dataset=ds,
                          output_type=pv.Float, function=program_identity)
        # Program
    ...
    def test_discrete_uniform_cutoff(self):
        ...
        prog = pv.Program("output", dataset=ds,
                          output_type=pv.Int, function=program_identity)
        # Program
        # self.create_file(lambda a: a)
    ...
    def test_constraints_greater_than_works(self):
        ...
        program = pv.Program("output", dataset=ds,
                             output_type=pv.Float, function=program_alpha)
