...
# Ints Value
BINOMIAL, BERNOULLI, GEOMETRIC, BETA_BINOMIAL, POISSON, DISCRETE_UNIFORM = range(
    6)
...
def MINIMUM_COVERAGE(low, high): return (
    MINIMUM_PERCANTAGE_COVERAGE/(high-low))
...
class Support:
    ...
    BETA = (0, 1)
    # Figure if this makes sense. Since if the range is (10, 30) than exponential has to either be shifted or it is useless
    EXPONENTIAL = (0, np.inf)
